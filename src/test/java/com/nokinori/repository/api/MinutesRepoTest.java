...
@DataJpaTest
public class MinutesRepoTest {

    @Autowired
    private TestEntityManager entityManager;

    @Autowired
    private MinutesRepo repo;

    private Minutes entity;
    ...
    public void entityCreated() {
        Optional<Minutes> found = createEntity();
    ...
    public void entityUpdated() {
        ...
        Optional<Minutes> found2 = repo.findById(entity.getId());
    ...
    public void entityRemoved() {
        ...
        Optional<Minutes> found3 = repo.findById(entity.getId());
    ...
    public void whenFindByUserIdThenReturnSimCard() {
        ...
        Optional<Minutes> found = repo.findByUserId(USER_ID);
        assertTrue(found.isPresent());
    ...
    public void entityEquals() {
        Minutes persist = entityManager.persist(entity);
        Optional<Minutes> found = repo.findById(persist.getId());
    ...
    private Optional<Minutes> createEntity() {
        Minutes persist = entityManager.persist(entity);
